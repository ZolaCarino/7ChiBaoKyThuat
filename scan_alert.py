...
def check_stock_score(symbol):
    ...
    try:
        ...
        bbl_curr, bbm_curr, bbm_prev, bbu_curr = safe_val(bbl_col, -1), safe_val(bbm_col, -1), safe_val(bbm_prev, -2), safe_val(bbu_col, -1)
...
def main():
    ...
    for symbol in WATCHLIST:
        ...
        if res and res["score"] >= 2: # Lọc chỉ lấy các mã có điểm số Tích cực trở lên
            ...
            # Định dạng danh hiệu dựa vào điểm số giống hệ thống web của anh
